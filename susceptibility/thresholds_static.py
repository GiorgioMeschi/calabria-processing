...
susc_file = '/home/sadc/share/project/calabria/data/susceptibility/static/susceptibility/SUSCEPTIBILITY.tif'
...
with rio.open(susc_file) as susc:
    ...
    # eval quantiles
    q1 = np.quantile(susc_values, 0.10)
    q2 = np.quantile(susc_values, 0.01)


folder = '/home/sadc/share/project/calabria/data/susceptibility/static/thresholds'
os.makedirs(folder, exist_ok=True)
# save in json
thresholds = dict(lv1=q1, lv2=q2)
