...
static_map_file = '/home/sadc/share/project/calabria/data/susceptibility/static/susc_classified/susc_3classes_v2.tif'
monthly_folder = '/home/sadc/share/project/calabria/data/susceptibility/v4/susc_classified'
outfolder = '/home/sadc/share/project/calabria/data/susceptibility/v4/PNG/trend_anomalies'
...
ba_anomalies = [ba_anomaly(area, mean_monthly_ba, std) for area in area_months]


# plot
fig, ax = plt.subplots(figsize=(30, 8), dpi = 200)
ax.plot(yearmonths, anomalis, marker='o', label = 'Annual anomaly', color = 'red')
